namespace Sledge.BspEditor.Editing.Components
{
    partial class AboutDialog
    {
		...
		private void InitializeComponent()
		{
			...
			label2.TabIndex = 5;
			label2.Text = "Created by Jdjd Gaming/SoftSprint Studios - ";
			// 
			// LTLink
			// 
			...
			label11.TabIndex = 9;
			label11.Text = "ParallaxED For parallax engine Based on hammer time by Yurii Hladyshenko";
			// 
			// AboutDialog
			// 
