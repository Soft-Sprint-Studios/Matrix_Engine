...
namespace Sledge.BspEditor.Rendering.Viewport
{
	...
	public class CameraNavigationViewportSettings : ISettingsContainer
	{
		...
		[Setting] public static int ForwardSpeed { get; set; } = 400;
		[Setting] public static decimal TimeToTopSpeed { get; set; } = 0.0m;
		...
		public IEnumerable<SettingKey> GetKeys()
		{
			...
			yield return new SettingKey("Navigation/3D", "FOV", typeof(int)) { EditorType = "Slider", EditorHint = "20,120,5,10,0.5" };
