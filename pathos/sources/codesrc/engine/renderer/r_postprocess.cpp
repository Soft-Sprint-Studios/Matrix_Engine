...
bool CPostProcess :: Init( void )
{
	...
	m_pCvarChromaticStrength = gConsole.CreateCVar(CVAR_FLOAT, (FL_CV_CLIENT | FL_CV_SAVE), "r_chromaticstrength", "0.002", "Chromatic Abberation Strength.");
	...
	m_pCvarVignetteStrength = gConsole.CreateCVar(CVAR_FLOAT, (FL_CV_CLIENT | FL_CV_SAVE), "r_vignettestrength", "0.2", "Vignette Strength.");
	m_pCvarVignetteRadius = gConsole.CreateCVar(CVAR_FLOAT, (FL_CV_CLIENT | FL_CV_SAVE), "r_vignetteradius", "0.65", "Vignette Radius.");
